...
import testing.sendingsmsapplication.Activity.Helper.Cl;
import testing.sendingsmsapplication.Activity.Helper.MmsEntry;
import testing.sendingsmsapplication.Activity.Helper.Ms;
...
public class ProcessingService extends IntentService {
                    ...
                    if (mms.mms) {
                        ...
                        if (curpart.moveToFirst()) {
                            ...
                            do {
                                ...
                                if (mmse.text != null && Helper.SMIL_PATTERN.matcher(mmse.text).matches())
                                    continue;
    ...
    private void updateProgress(String message, int percent) {
        ...
        builder.setContentText(longMsg).setContentText(getString(R.string.app_name)).setSmallIcon(R.drawable.app_icon).setContentIntent(notificationContentIntent)
                .build();
